...
const GLuint GAME_SCORE_TURN = 3;

const GLuint PLAYER_MAX_NUM = 5;
...
const OPERATION_STATE RED_TEAM_OPERATION_STATE[] = { IDLE, DEFEND, ATTACK, IDLE, IDLE };
const OPERATION_STATE BLUE_TEAM_OPERATION_STATE[] = { IDLE, DEFEND, ATTACK, IDLE, IDLE };

const GLfloat PLAYER_SPEED = 20;
const glm::vec2 PLAYER_SIZE = glm::vec2(6.0f, 6.0f);
const GLuint IDEL_WAIT_TIME = 100;
const GLuint KICK_WAIT_TIME = 100;
const GLfloat PLAYER_WEIGHT = 5.0f;
